...
const Footer: React.FunctionComponent<FooterProps> = ({
  ...
  <footer className={`${style.footer} ${grid.centered}`}>
      ...
      <section className="footer__navigation-section">
        ...
        <ul className="footer__navigation-list">
          <li className="footer__navigation-item">
            <a href={`${cmsURL}/${languageCode}/invest`} className="footer__navigation-link">Invest</a>
          </li>
          <li className="footer__navigation-item">
            <a href={`${cmsURL}/${languageCode}/raise`} className="footer__navigation-link">Raise</a>
          </li>
          <li className="footer__navigation-item">
            <a href={`${cmsURL}/${languageCode}/about`} className="footer__navigation-link">About</a>
          </li>
        </ul>
      </section>
      <section className="footer__navigation-section">
